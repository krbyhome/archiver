# Архиватор HamArc
Помехоустойчивый архиватор файлов без сжатия, объединяющий несколько файлов в один архив. Для помехоустойчивого кодирования используются [Коды Хэмминга](https://en.wikipedia.org/wiki/Hamming_code). 
Структура хранения данных описана в файл structure.txt библиотеки haf
